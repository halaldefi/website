...
const halalData = [
  ...
  },
  {
    ...
    answer:
      "<div> <span class='text-gradient_halal' style='font-weight:bold'> Halal DeFi is a Shariah-compliant decentralized finance platform </span> that functions similarly to a venture capital fund on the blockchain. Our platform enables you to invest in ethical Web3 and blockchain projects while strictly adhering to Islamic finance principles, ensuring that all investments are free from interest (riba), excessive uncertainty (gharar), and other prohibited activities.</div><div style='font-weight:bold;margin-top:30px'>How it works</div> <li>Invest: Purchase $HDF tokens, which represent a share in our investment portfolio.</li><li>Allocate : Funds from token sales are strategically invested in high-potential, Shariah-compliant blockchain projects and used for ethical trading.</li><li>Grow: As these investments generate returns, the value of $HDF tokens increases, offering you a profitable and compliant investment opportunity.</li>",
    isHtml: true,
  },
  {
    id: "item-3",
  ...
  },
  {
    ...
    isHtml: true,
    answer:
      "Starting with Halal DeFi is<span class='text-gradient_halal' style='font-weight:bold'> simple and straightforward: </span> <li style='margin-top:10px'>Get $HDF Tokens: Purchase $HDF tokens on our Halal DEX or other supported exchanges like Uniswap, PancakeSwap, or 1Inch. You can sign up using your email or phone number, and even buy crypto using your debit or credit card. </li><li>Store Your Tokens: Securely store your $HDF tokens in your own wallet. We are a non-custodial service, meaning you control your wallet and private keys, ensuring that your assets are fully under your control. </li><li>Monitor Your Investment: As we invest in and trade high-potential blockchain projects, you can track the value of your $HDF tokens as they grow.</li><li>Trade Anytime: You can trade your $HDF tokens on any supported exchange whenever you choose, with no restrictions.</li>",
  },
  {
    "id": "item-6",
    "question": "Is Halal DeFi a custodial or non-custodial service? What does that mean, and what are the legal implications?",
    "isHtml": true,
    "answer": "<span class='text-gradient_halal' style='font-weight:bold'>Halal DeFi is a non-custodial service,</span> meaning you control your wallet and private keys—your assets are entirely in your hands.<li style='margin-top:10px'>What this means:</li><li>Non-Custodial: You have full ownership and responsibility for your funds. We do not have access to your assets.</li><li>Custodial: In contrast, custodial services (like Binance & Coinbase) hold your funds and control your private keys.</li><li style='margin-top:10px'>Legal Implications:</li><li>Get $HDF Tokens: Purchase $HDF tokens on our <span class='text-gradient_halal' style='font-weight:bold'>Halal DEX</span> or other supported exchanges like Uniswap, PancakeSwap, or 1Inch. You can sign up using your email or phone number, and even buy crypto using your debit or credit card.</li><li>Store Your Tokens: Securely store your $HDF tokens in your own wallet. We are a non-custodial service, meaning you control your wallet and private keys, ensuring that your assets are fully under your control.</li><li>Monitor Your Investment: As we invest in and trade high-potential blockchain projects, <span class='text-gradient_halal' style='font-weight:bold'>you can track the value of your $HDF tokens as they grow.</span></li><li>Trade Anytime: You can trade your $HDF tokens on any supported exchange whenever you choose, with no restrictions.</li><li style='margin-top:10px'>This approach gives you greater control over your investments, aligned with decentralized finance principles.</li>"
  },  
  {
    id: "item-7",
    question:
  ...
  },
  {
    id: "item-9",
    question:
      "What kind of returns can I expect from investing in $HDF tokens?",
    isHtml: true,
    answer:
      "The returns on $HDF tokens depend on the success of our investments and trading activities. While we aim to achieve significant growth by investing in high-potential Web3 and blockchain projects, <span class='text-gradient_halal' style='font-weight:bold'>it’s important to understand that returns can vary based on market conditions and the performance of these projects.</span><li style='margin-top:10px'>Potential Returns:</li><li>Growth-Oriented Investments: By focusing on early-stage projects with strong potential, we aim to deliver substantial returns. However, specific returns are not guaranteed and can fluctuate over time.</li><li>Token Value Appreciation: As our portfolio grows and succeeds, the value of $HDF tokens is expected to increase, reflecting the underlying assets' performance.</li><li>Important Note: While we strive for positive returns, all investments carry risk. It’s essential to consider your risk tolerance and invest wisely.</li>",
  },
  {
    id: "item-10",
    question:
      "What are the risks of investing in $HDF tokens? Can the value decrease?",
    isHtml: true,
    answer:
      "Investing in $HDF tokens, like any investment, comes with risks, and the value of your tokens can indeed decrease. Here are some of the key risks to be aware of:<li style='margin-top:10px'>Market Volatility: The value of $HDF tokens can fluctuate due to changes in market conditions, <span class='text-gradient_halal' style='font-weight:bold'>including the performance of the broader cryptocurrency market.</span> These fluctuations can lead to both gains and losses.</li><li>Investment Risk: The success of our investments in Web3 and blockchain projects is not guaranteed. If the projects we invest in underperform or fail, it could negatively impact the value of $HDF tokens.</li><li>Liquidity Risk: While $HDF tokens can be traded on decentralized exchanges, the liquidity of these tokens may vary. In periods of low liquidity, it may be more challenging to buy or sell tokens without affecting the market price.</li><li>Regulatory Risk: Changes in regulations affecting cryptocurrency and DeFi could impact the value and tradability of $HDF tokens.</li><li>Yes, the value of $HDF tokens can decrease due to the factors mentioned above. It’s important to carefully consider these risks and invest according to your risk tolerance.</li>",
  },
  {
    id: "item-11",
    ...
    isHtml: true,
    answer:
      "<span class='text-gradient_halal' style='font-weight:bold'>The total supply of $HDF tokens is fixed at 100 million.</span> This means there will never be more than 100 million $HDF tokens in circulation, ensuring scarcity and helping to maintain the value of the tokens as demand grows.",
  },
  {
    id: "item-12",
    question: "How can I purchase or trade $HDF tokens?",
    isHtml: true,
    answer:
      "You can easily purchase or trade $HDF tokens on several decentralized exchanges:<li style='margin-top:10px'><span class='text-gradient_halal' style='font-weight:bold'>Halal DEX:</span> Visit our Halal DEX for a beginner-friendly experience. You can sign up using your email or phone number, create a wallet, and even buy crypto using a debit or credit card.</li><li>Uniswap, PancakeSwap, and 1Inch: $HDF tokens are also available on popular decentralized exchanges like Uniswap, PancakeSwap, and 1Inch. Simply connect your wallet and trade $HDF tokens on your preferred platform.</li><li>Steps to Buy or Trade:</li><li>Choose Your Exchange: Select Halal DEX or any of the supported DEXs.</li><li>Connect Your Wallet: Ensure your wallet is connected to the exchange.</li><li>Buy or Trade: Enter the amount of $HDF tokens you want to buy or trade and complete the transaction.</li><li>You can buy or sell $HDF tokens anytime, 365 days a year, <span class='text-gradient_halal' style='font-weight:bold'>without restrictions.</span></li>",
  },
  {
    id: "item-13",
    question: "Can I use $HDF tokens for governance or voting?",
    isHtml: true,
    answer:
      "Currently, $HDF tokens do not have governance or voting rights. <span class='text-gradient_halal' style='font-weight:bold'>However, we are exploring the possibility of introducing governance features in the future,</span> where token holders could participate in key decisions regarding the platform's direction and investments.<li style='margin-top:10px'>Stay tuned for updates as we continue to develop and expand the utility of $HDF tokens.</li>",
  },
  ...
  },
  {
    ...
    isHtml: true,
    answer:
      "Halal.io is designed to be globally accessible, and <span class='text-gradient_halal' style='font-weight:bold'>$HDF tokens can be purchased by users from most countries.</span> However, due to regulatory restrictions, residents of certain jurisdictions may be unable to participate in the purchase of $HDF tokens.<li style='margin-top:10px'>We recommend that you check the specific regulations in your country before purchasing tokens.</li>",
  },
  {
    id: "item-18",
    question:
  ...
  },
  {
    ...
    isHtml: true,
    answer:
      "When you hold $HDF tokens, you're participating in the growth of our carefully selected investments. <span class='text-gradient_halal' style='font-weight:bold'>As a non-custodial platform, Halal DeFi does not control your funds;</span> instead, the value of your tokens reflects the performance of our overall portfolio.<li style='margin-top:10px'>Here's how we manage investments:</li><li>Strategic Investments: We invest in early-stage Web3 and blockchain projects that have high growth potential and comply with Shariah principles. These investments drive the value of $HDF tokens.</li><li>Active Trading: We also engage in trading on decentralized exchanges, taking advantage of market opportunities. Successful trades contribute to the increase in your token's value.</li><li>Token Value Growth: As our investments and trades succeed, the value of $HDF tokens increases. You maintain full control of your tokens, with the ability to buy or sell them at any time on supported DEXs.</li><li>Your tokens remain fully under your control, and you benefit from the growth of our portfolio without us holding or managing your assets directly.</li>",
  },
];
