              ...
              <div className="z-20 flex w-full flex-col flex-wrap p-16 lg:flex-row">
                ...
                <div className="relative w-full text-white lg:w-3/5">
                  <p>
                    ...
                    decentralized finance. Our founders have strong backgrounds
                    in tech, finance, and strategic investing, enabling us to
                  ...
                  <p className="mt-10">
                    ...
                    strategic, technology-driven approach. enabling us to select
                    projects with high growth potential that adhere to Shariah
                    principles.
                  </p>
                </div>
              </div>
